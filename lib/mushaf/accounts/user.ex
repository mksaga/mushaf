defmodule Mushaf.Accounts.User do
  use Ecto.Schema
  ...
  defp validate_email(changeset) do
    ...
    |> unsafe_validate_unique(:email, Mushaf.Repo)
  ...
  """
  def valid_password?(%Mushaf.Accounts.User{hashed_password: hashed_password}, password)
